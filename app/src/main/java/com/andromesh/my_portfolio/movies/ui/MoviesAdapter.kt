...
import com.andromesh.my_portfolio.databinding.ListItemMovieBinding
...
class MoviesAdapter : PagedListAdapter<Movie, MoviesAdapter.ViewHolder>(MovieDiffCallback()) {
    ...
    private fun createOnClickListener(movie: Movie): View.OnClickListener {
        return View.OnClickListener {
            val direction = MoviesFragmentDirections.actionMoviesFragmentToMovieFragment(movie.imdbID, movie.title)
